...
public class AppConfig 
{
	...
	public static String userCredentialsFilePath = "../Leadprime Automation/LeadPrime Dependancy Files/IDMART Names & Pwds.xlsx";
    ...
    public static String filePath = "../Leadprime Automation/LeadPrime Dependancy Files/IndiaMart_Leads.xlsx";
    ...
    public static String areaLocationsSheet = "../Leadprime Automation/LeadPrime Dependancy Files/Area Locations.xlsx";
